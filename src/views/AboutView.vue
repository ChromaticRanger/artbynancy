<template>
  <div class="about-container max-w-4xl mx-auto px-6 py-12">
    ...
    <div class="prose prose-4xl max-w-none text-gray-700 leading-relaxed space-y-6">
      ...
      <p>
        Art by Nancy brings her world together in themed galleries that invite you to explore her vision across different subjects—Italy, San Francisco, botanical art, home portraits, and other journeys taken. Each work reflects the joy she finds in translating a moment or a place into lasting imagery.
      </p>
